...
<html lang="en">
  ...
  <body class="text-center">    
    <main class="form-signin w-100 m-auto">
      <form action="{{url('/build')}}">
        <h1 class="h3 mb-3 fw-normal">Build Produk</h1>
        ...
        <div class="form-floating">
          ...
          <label for="nama">Pilih Builder</label>
        </div>
        <button class="w-100 btn btn-lg btn-warning" type="submit" style="margin-top: 5%;">Build Produk</button>
        <a type="button" href="{{url('/home')}}">Kembali ke Home</a>
      </form>
